...
// Definir si la pagina es la activa mediante la url
const inPage = (value) => {
    const page = usePage();
    return page.url.value === value;
};
</script>
...
<template>
    <div class="flex">
        ...
        <div
            ...
            @click="isOpen = !isOpen"
            class="fixed inset-0 z-20 transition-opacity bg-[#004a77] opacity-50 lg:hidden"
        ></div>
        <!-- End Backdrop -->
        ...
        >
            <!-- Nombre principal -->
            <div
                class="flex items-center justify-center mt-4 border-white border-b-2 pb-1"
            >
            ...
            <!-- links -->
            <nav class="mt-10">
                <p class="flex items-center px-6 py-2 duration-200 text-white">
                    <small>Menú</small>
                </p>
                <Link
                    :href="route('profile')"
                ...
                <!-- <Link
                    ...
                    class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4 text-white"
                    :class="[
                        inPage(appPages.sales) ? activeClass : inactiveClass,
                    ]"
                    @click="isOpen = !isOpen"
                >
                    <svg
