    ...
    <BreezeGuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <BreezeInput id="user" type="text" class="mt-1 block w-full" v-model="form.user" required autocomplete="username" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('main')" class="underline text-sm text-gray-600 hover:text-gray-900">
                    Already registered?
                </Link>
